...
@section('content')
  <h1 class="text-2xl font-bold mb-4">Nueva Facultad</h1>

  <form class="bg-white shadow rounded p-4 max-w-xl" method="POST" action="{{ route('web.facultades.store') }}">
    @csrf
    ...
    <div class="mb-4">
      ...
      <input name="sigla" class="w-full border rounded px-3 py-2" placeholder="FICCT">
    </div>
