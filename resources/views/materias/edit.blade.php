...
@section('content')
  ...
  <form class="bg-white shadow rounded p-4 max-w-xl" method="POST" action="{{ route('web.materias.update',$item) }}">
    @csrf @method('PUT')
    <div class="mb-3">
    ...
    <div class="flex gap-2">
      ...
      <a class="px-4 py-2 bg-gray-200 rounded" href="{{ route('web.materias.index') }}">Cancelar</a>
    </div>
  </form>
@endsection
